...
<!-- 
        ...
        <div class="row text-center mb-5">
            <div class="col-lg-12">
                ...
                <p class="lead"> A versatile IPTV OTT box offering seamless streaming of live TV and on-demand content with high-
        ...
        <div class="row mb-4">
            <div class="col-md-8">
                <img src="assets/img/ott.jpg" class="img-fluid rounded shadow" style="width: 100%; height: 500px;" alt="ZNM800 Image 1">
            </div>
    ...
    <div class="col-md-5">
        ...
        <!-- <div class="row text-center mb-5">
            <div class="col-lg-12">
                ...
                <p class="lead">P97: A versatile IPTV OTT box offering seamless streaming of live TV and on-demand content with high-
                definition support.</p>
            </div>
        </div>
        ...
        <div class="row mb-4">
            <div class="col-md-12">
                <img src="assets/img/ott2.jpg" class="img-fluid rounded shadow" style="width: 100%; height: 700px;" alt="GB720 Image 1">
            </div>
...
<div class="col-md-5">
    ...
    <!-- Right Side: Image -->
    <!-- <div class="col-md-6">
        <img src="assets/img/ott2.jpg" class="img-fluid rounded shadow" style="width: 100%; height: 500px;" alt="OTT Box Image">
    </div> -->
</div>
